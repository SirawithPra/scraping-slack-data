...
ถ้าขึ้น help และ pytest ผ่านหมด (**124 passed**) ถือว่าฝั่ง Python พร้อม
...
ของ Slack ติดมาด้วย · บนหน้าจอและใน Slack card ที่มาจะขึ้นว่า **แชทที่วาง** (📋) ไม่ใช่
**Slack** เพราะข้อความที่ export มาคือข้อความเต็ม ส่วนข้อความที่วางคือเท่าที่คนเลือกมา
